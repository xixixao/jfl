...
test('Cl', async () => {
  ...
  not.tru(Cl.every($Mp({k: 'adam', m: 'boris', n: 'cecil'}), x => x === 'boris'));
  ...
  eqqq(Cl.find([2, 3, 8], x => Mth.isOdd(x)), 3);
  eqqq(Cl.find($St(2, 3, 8), x => Mth.isOdd(x)), 3);
  eqqq(Cl.find($Mp({k: 2, m: 3, n: 8}), x => Mth.isOdd(x)), 3);
  ...
  eqqq(Cl.findX([2, 3, 8], x => Mth.isOdd(x)), 3);
  eqqq(Cl.findX($St(2, 3, 8), x => Mth.isOdd(x)), 3);
  eqqq(Cl.findX($Mp({k: 2, m: 3, n: 8}), x => Mth.isOdd(x)), 3);
  ...
  eqqq(Cl.findKey([2, 3, 8], x => Mth.isOdd(x)), 1);
  eqqq(Cl.findKey($St(2, 3, 8), x => Mth.isOdd(x)), 3);
  eqqq(Cl.findKey($Mp({k: 2, m: 3, n: 8}), x => Mth.isOdd(x)), 'm');
  ...
  eqqq(Cl.findKeyX([2, 3, 8], x => Mth.isOdd(x)), 1);
  eqqq(Cl.findKeyX($St(2, 3, 8), x => Mth.isOdd(x)), 3);
  eqqq(Cl.findKeyX($Mp({k: 2, m: 3, n: 8}), x => Mth.isOdd(x)), 'm');
  ...
  eqqq(Cl.reduce(['a', 'b', 'c'], (word, letter) => word + letter), 'abc');
